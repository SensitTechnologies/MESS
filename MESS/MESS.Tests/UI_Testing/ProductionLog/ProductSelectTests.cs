...
public class ProductSelectTests : TestContext
{
    ...
    public void ProductSelectComponentFiresOnProductSelectedEvent()
    {
        ...
        var cut = RenderComponent<ProductSelect>(parameters => parameters
            ...
            .Add(p => p.Products, new List<Product>
            {
                ...
                {
                    Id = 1,
                    PartDefinition = new PartDefinition { Id = 10, Number = "P-100", Name = "Product 1" },
                    WorkInstructions = new List<WorkInstruction>
                    {
                        new WorkInstruction
                        {
                            ...
                            {
                                new Step { Name = "Step 1", Body = "Step 1" },
                                new Step { Name = "Step 2", Body = "Step 2" },
                                new Step { Name = "Step 3", Body = "Step 3" }
                            }
                        }
                    }
                },
                ...
                {
                    Id = 2,
                    PartDefinition = new PartDefinition { Id = 20, Number = "P-200", Name = "Product 2" },
                    WorkInstructions = new List<WorkInstruction>()
                }
            }));
    ...
    [Fact]
    public void ProductSelectComponentHandlesEmptyPartName()
    {
        // Arrange
        var products = new List<Product>
        {
            ...
            {
                Id = 1,
                PartDefinition = new PartDefinition { Id = 10, Number = "P-100", Name = "" },
                WorkInstructions = new List<WorkInstruction>(),
                IsActive = true
            }
        };
    ...
    [Fact]
    public void ProductSelectComponentHandlesLongPartName()
    {
        // Arrange
        ...
        var products = new List<Product>
        {
            ...
            {
                Id = 1,
                PartDefinition = new PartDefinition { Id = 10, Number = "P-100", Name = longName },
                WorkInstructions = new List<WorkInstruction>(),
                IsActive = true
            }
        };
        ...
        // Assert
        var options = cut.FindAll("option");
        Assert.Equal(2, options.Count); // Including default "Select Product" option
    ...
    public void ProductSelectComponentHandlesDuplicateProductIds()
    {
        ...
        // Assert
        var options = cut.FindAll("option");
        Assert.Equal(3, options.Count); // Including the default option
        Assert.Equal("Product 1", options[1].TextContent);
        Assert.Equal("Product 2", options[2].TextContent);
    }
    ...
    public void ProductSelectComponentHandlesLargeNumberOfProducts()
    {
        ...
        var products = Enumerable.Range(1, 1000)
            ...
            {
                Id = i,
                PartDefinition = new PartDefinition { Id = i, Number = $"P-{i:D4}", Name = $"Product {i}" },
                WorkInstructions = new List<WorkInstruction>(),
                IsActive = true
            })
            .ToList();
        ...
        // Assert
        var options = cut.FindAll("option");
        Assert.Equal(1001, options.Count); // Including default
        Assert.Equal("Product 1", options[1].TextContent);
